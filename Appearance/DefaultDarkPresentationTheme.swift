...
private let navigationBar = PresentationThemeRootNavigationBar(
    buttonColor: accentColor,
    disabledButtonColor: UIColor(rgb: 0x525252),
    primaryTextColor: accentColor,
    secondaryTextColor: UIColor(rgb: 0xffffff, alpha: 0.5),
    barTintColor: UIColor(rgb: 0x1c1c1d),
    tintColor: .white,
    backgroundColor: UIColor(rgb: 0x2B2C2E),
    separatorColor: UIColor(rgb: 0x000000),
    badgeBackgroundColor: UIColor(rgb: 0xffffff),
    badgeStrokeColor: UIColor(rgb: 0x1c1c1d),
...
private let viewController = PresentationThemeViewController(backgroundColor: UIColor(rgb: 0x1c1c1d))

private let tableView = PresentationThemeTableView(
    backgroundColor: UIColor(rgb: 0x1c1c1d),
    selectedBackgroundColor: .white,
    groupBackgroundColor: UIColor(red: 28/255, green: 28/255, blue: 30/255, alpha: 1),
    cellBackgroundColor: UIColor(rgb: 0x2B2C2E),
    cellAccessoryColor: UIColor(rgb: 0xfefefe),
    separatorColor: .black,
    skeletonGradientColor: .gray
)

private let button = PresentationThemeButton(primaryColor: .white, secondaryColor: .gray, tintColor: .white, backgroundColor: UIColor(rgb: 0xFF0000), hightlightColor: UIColor(rgb: 0x797d86))
private let downloadButton = PresentationDownloadButton(initialColor: .black, rippleColor: .black, downloadColor: .black, deviceColor: .black, buttonBackgroundColor: .clear, backgroundColor: .white)
private let label = PresentationThemeLabel(primaryColor: UIColor(rgb: 0xfefefe), secondaryColor: .gray, mentionColor: UIColor(rgb: 0x3590EB), linkColor: UIColor(rgb: 0x3590EB), timeMessageColor: .white)

private let popUpView = PresentationThemePopUp(primaryColor: .white, secondaryColor: .gray, tintColor: .white, backgroundColor: UIColor(rgb: 0x1c1c1d), hightlightColor: UIColor(white: 0.0, alpha: 1.0))

private let searchBar = PresentationThemeSearchBar(
    backgroundColor: UIColor(rgb: 0x333336),
    ...
    tintColor: UIColor(rgb: 0xfefefe)
)
...
private let bubble = PresentationThemeChatBubble(
    incoming: PresentationThemeBubbleColor(
        withWallpaper: PresentationThemeBubbleColorComponents(
            bubleColor: UIColor(rgb: 0x1B2A38),
            textColor: .white,
            tintColor: .white,
    ...
    outgoing: PresentationThemeBubbleColor(
        withWallpaper: PresentationThemeBubbleColorComponents(
            bubleColor: UIColor(rgb: 0x2B2B2B),
            textColor: .white,
            tintColor: .white,
            timeMessageColor: .white
        ),
    ...
    outgoingPolls: PresentationThemeChatBubblePolls(
        radioButton: UIColor(rgb: 0x838383),
        radioProgress: accentColor,
        highlight: accentColor.withAlphaComponent(0.12),
        separator: UIColor(white: 0.3, alpha: 1.0),
        bar: accentColor
    ),
    replyBackGroundColor: UIColor(rgb: 0x555555).withAlphaComponent(0.30)
)

private let serviceMessage = PresentationThemeServiceMessage(
    components: PresentationThemeServiceMessageColor(
        withDefaultWallpaper: PresentationThemeServiceMessageColorComponents(
            fill: UIColor(rgb: 0x1f1f1f, alpha: 1.0),
            primaryText: UIColor(rgb: 0xffffff),
            linkHighlight: UIColor(rgb: 0xffffff, alpha: 0.12),
            dateFillStatic: UIColor(rgb: 0x1f1f1f, alpha: 1.0),
            dateFillFloating: UIColor(rgb: 0xffffff, alpha: 0.2)
        ),
...
private let stickerView = PresentationThemeStickerView(
    headerBackgroundColor: UIColor(rgb: 0x010101),
    selectedHeaderColor: UIColor(rgb: 0x252527),
    backgroundColor: UIColor(rgb: 0x010101),
    footerColor: UIColor(rgb: 0x010101))
