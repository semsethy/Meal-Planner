...
class ViewRecipe: UIViewController {
    ...
    func setUpUI() {
        ...
        IngredientTableView.register(ViewRecipeCell.self, forCellReuseIdentifier: "cell")
...
@available(iOS 13.0, *)
extension ViewRecipe: UITableViewDelegate, UITableViewDataSource{
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return ingredients.count
    }
    
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as! ViewRecipeCell
        let ingredient = ingredients[indexPath.item]
        cell.titleLabel.text = ingredient.ingredients
