...
@available(iOS 13.0, *)
class SeeAllSpecialCell: UICollectionViewCell {
    ...
    private lazy var gradientOverlayView: GradientOverlayView1 = {
        let gradientView = GradientOverlayView1()
//        gradientView.isSkeletonable = true
        return gradientView
    }()
    
    let context = (UIApplication.shared.delegate as! AppDelegate).persistentContainer.viewContext
    var item: SpecialRecipes?
...
//        showSkeleton()
    ...
    func configure(with recipe: SpecialRecipes) {
        item = recipe
